...
export default function Contact(){
    ...
    return (
        <div name='contact' className="w-full md:h-screen flex justify-center items-center bg-[#0a192f] p-4">
            <form data-aos="fade-up" method="POST" action="https://getform.io/f/86143982-5c72-49e9-94a1-6a6f7cb06c78" className="flex flex-col max-w-[600px] w-full">
                <div className="pb-8">
                    <p className="text-4xl text-gray-300 font-bold inline border-b-4 border-[#FFD966]">Contact</p>
                    <p className="text-gray-300 py-4">For any suggestions or for connecting with me, please submit the form below or shoot me an email at- aditya110902@gmail.com</p>
                </div>
